                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input class="form-control" value="" name="address" type="text" placeholder="Name">
                            </div>
                        </div>
                    </div>
                    <hr>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" value="" name="fee" type="text" placeholder="Administration Fee">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="fw-bold">Fines</label>
                                        <input class="form-control" value="" name="fines" type="text" placeholder="Denda">
                                    </div>
                                </div>
                            </div>
                        </div>
